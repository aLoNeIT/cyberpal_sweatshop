...
class Dict
{
     ...
     * @var DictItem|null
     */
    protected ?DictItem $primaryKey = null;

    /**
     * 字典构造函数
     *
     * @param array $data 字典主数据
     */
     ...
     * @return static 返回当前对象
     */
    public function addItem(array|DictItem $data): static
    {
     ...
     * @return Dict 返回当前对象，链式操作
     */
    public function setItemAll(array $data, bool $prefixed = false): Dict
    {
     ...
     */
    public function eachItem(\Closure $callback): bool
    {
